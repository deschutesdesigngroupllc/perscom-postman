...
To contribute to this project, you'll need to fork the repository to your own GitHub account. Click the "Fork" button on the top-right corner of the [repository page](https://github.com/DeschutesDesignGroupLLC/perscom-postman).
...
```shell
git clone https://github.com/DeschutesDesignGroupLLC/perscom-postman.git
```
...
Then, navigate to the [original repository](https://github.com/DeschutesDesignGroupLLC/perscom-postman) and create a pull request. Provide a clear title and description of your changes.
...
By contributing to this project, you agree that your contributions will be licensed under the [project's license](https://github.com/DeschutesDesignGroupLLC/perscom-postman).
